...
## [Code of Conduct](https://github.com/virtomize/csv2json/blob/master/CODE_OF_CONDUCT.md)

The csv2json project follows the [Contributor Covenant Code of Conduct](https://github.com/virtomize/csv2json/blob/master/CODE_OF_CONDUCT.md)
...
- By opening an issue for discussion: For example, if you found a bug, creating a bug report using the [template](https://github.com/virtomize/csv2json/blob/master/.github/ISSUE_TEMPLATE/bug_report.md) is the way to report it.
- By providing supporting details to an existing issue: For example, additional testcases.
- By helping to resolve an issue: For example by opening a [Pull Request](https://github.com/virtomize/csv2json/pulls)

### Asking for Help

Just open a [regular issue](https://github.com/virtomize/csv2json/issues/new) and describe your problem.
...
Fork the project [on Github](https://github.com/virtomize/csv2json/) and clone your fork

```
$ git clone git@github.com:username/csv2json.git
$ cd csv2json
$ git remote add upstream https://github.com/virtomize/csv2json.git
$ git feth upstream
```
...
If your commits are ready to go and passed all tests and linting, you can start creating a [Pull Requests](https://github.com/virtomize/csv2json/pulls) by pushing your work branch to your fork on GitHub.
...
Contributors guide: https://github.com/virtomize/csv2json/blob/master/CONTRIBUTING.md
-->
...
Also follow the [Code of Conduct](https://github.com/virtomize/csv2json/blob/master/CODE_OF_CONDUCT.md)
